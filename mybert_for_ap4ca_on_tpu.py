# -*- coding: utf-8 -*-
"""MyBERT for AP4CA on TPU.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1j4bgjDleI2ccskFtK_M4K83si_qWZ7bR
...
Il tutor ha puntualizzato di usare SOLO lo script `sampler/mm_action_prediction/tools/extract_actions_fashion.py`, che costruisce un json con le lables associate alle azioni e agli attributi (è lo step 1 del preprocessing).
